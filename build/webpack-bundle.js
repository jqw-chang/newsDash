...
(0, _reactDom.render)(_react2.default.createElement(_Home2.default, null), document.getElementById('root'));
...
var _results = __webpack_require__(60);
...
var sources = { // source name : source id
  CNN: 'cnn',
...
var Home = function (_Component) {
  ...
  function Home() {
    ...
    _this.getSearchTerm = _this.getSearchTerm.bind(_this);
    ...
    _this.handleArticleToggle = _this.handleArticleToggle.bind(_this);
    _this.handleArticleSave = _this.handleArticleSave.bind(_this);
    _this.openNewTab = _this.openNewTab.bind(_this);
    return _this;
  }
  ...
  _createClass(Home, [{
    ...
    key: 'toggleCheckbox',
    value: function toggleCheckbox(label, isChecked) {
      isChecked = !isChecked;
    ...
    key: 'getSearchTerm',
    value: function getSearchTerm(event) {
      this.setState({
    ...
    value: function handleOnSubmit(event) {
      ...
      this.selectedCheckboxes.forEach(function (source) {
        count++;
        checkedSources += sources[source] + ',';
      });

      checkedSources = checkedSources.slice(0, -1);
      var url = 'https://newsapi.org/v2/everything?q=' + this.state.topic + '&sources=' + checkedSources + '&sortBy=popularity&apiKey=6bfbd78dd5c64b3c9f6642e69d60f7e1';

      if (this.state.topic === '' && count === 0) {
        var allCheckedSources = Object.values(sources).join(',');
    ...
    key: 'handleArticleToggle',
    value: function handleArticleToggle(article) {
      if (this.selectedArticles.has(article)) {
        this.selectedArticles.delete(article);
      } else this.selectedArticles.add(article);
    }
  }, {
    key: 'handleArticleSave',
    value: function handleArticleSave() {
      var _this3 = this;

      var articlesToSave = [];
      this.selectedArticles.forEach(function (article) {
      ...
      fetch('/saveArticles', options).then(function (res) {
        return res.json();
      }).then(function (res) {
        _this3.setState({
          showResultsRes: true,
    ...
    value: function render() {
      ...
      return [_react2.default.createElement(
        'div',
        { key: 0, className: 'h3', style: mediaStyle },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            { className: 'h1' },
            'Welcome To Your News Dash'
          )
        ),
        'Choose Media:',
        _react2.default.createElement(
          'button',
          { id: 'ReadingMode', style: { float: 'right' } },
          'Reading Mode On'
        ),
        _react2.default.createElement(
          'center',
          ...
          _react2.default.createElement(_searchbar2.default, { getSearchTerm: this.getSearchTerm }),
          _react2.default.createElement(
            'button',
            { id: 'submit', onClick: this.handleOnSubmit, style: btnStyle },
            ' Submit '
          )
        )
      ), _react2.default.createElement(_results2.default, { key: 1, openNewTab: this.openNewTab, articles: this.state.results, showing: this.state.showing, toggleArticle: this.handleArticleToggle, saveArticle: this.handleArticleSave, showResultsRes: this.state.showResultsRes, resultsBtn: this.state.resultsBtn, resultsRes: this.state.resultsRes })];
    }
  }]);
...
function Searchbar(_ref) {
  var getSearchTerm = _ref.getSearchTerm;

  var msg = "You about to learn today!";
  var sbStyle = {
    width: '400px',
    height: '20px'
  };

  return _react2.default.createElement('input', { type: 'text', placeholder: msg, onChange: getSearchTerm, style: sbStyle });
}
...
function Results(_ref) {
  var articles = _ref.articles,
      ...
      toggleArticle = _ref.toggleArticle,
      saveArticle = _ref.saveArticle,
      showResultsRes = _ref.showResultsRes,
      resultsBtn = _ref.resultsBtn,
      resultsRes = _ref.resultsRes;
  ...
  return [_react2.default.createElement(
    'div',
    { key: 0, className: 'h3', id: 'results', style: outStyle },
    _react2.default.createElement(
      'div',
      { key: 1 },
      _react2.default.createElement(
      ...
      _react2.default.createElement(
        'button',
        { type: 'submit', onClick: saveArticle },
        'save'
      ),
      _react2.default.createElement(
        'div',
    ...
    _react2.default.createElement(
      'div',
      { key: 2, className: 'resultsList', style: divStyle },
      _react2.default.createElement(
        'ul',
        null,
        articles.map(function (article, i) {
          ...
          return [_react2.default.createElement(
            'li',
            { key: i, className: 'result', style: { listStyle: 'none' } },
            _react2.default.createElement('input', { type: 'checkbox',
              style: btnStyle,
              onChange: function onChange() {
                return toggleArticle(article);
              } }),
            _react2.default.createElement(
              'a',
              { href: '#', onClick: function onClick() {
                  return openNewTab(article.url);
                } },
              article.title
            ),
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement("input", {
        ...
        value: label,
        onChange: function onChange() {
          return isChecked = handleCheckboxChange(label, isChecked);
        }
      }),
      label
    )
